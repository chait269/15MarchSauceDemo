...
public class Tc14CancelButtonFunctionality 
{
	public static void main(String[] args) 
	{
		...
		String ExpectedCancelButtonClick="https://www.saucedemo.com/inventory.html";
		System.out.println("Expected cancel button click url is-"+ ExpectedCancelButtonClick);
		
		String ActualCancelButtonClick=driver.getCurrentUrl();
		System.out.println("Expected cancel button click url is-"+ ActualCancelButtonClick);
		
		System.out.println("validating functionality of cancel button");
		
		if(ExpectedCancelButtonClick.equals(ActualCancelButtonClick))
		{
		...
		{
			System.out.println("Cancel button functionality is not working fine");
